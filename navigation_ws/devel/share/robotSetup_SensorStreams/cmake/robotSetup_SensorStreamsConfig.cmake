...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotSetup_SensorStreams' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marifer/ROS-Tutorials/navigation_ws/src/robotSetup_SensorStreams/${idir}'.  Ask the maintainer 'marifer <marifer@todo.todo>' to fix it.")
    endif()
