    ...
    */
    ...
    namespace gazebo
    {
        /* plugin inherits GUIPlugin class & use Qt's Q_OBJECT macro*/
      class GAZEBO_VISIBLE GUIExampleTimeWidget : public GUIPlugin
      {
        ...
        /* SetSimTime signal as a thread safe mechanism to update the displayed simulation time*/
        ...
        /* OnStats callback is used to receive info from Gazebo*/
