  ...
  : GUIPlugin()
{
  ...
  /**** Constructor uses QT to create a button& attach it to our OnButton callback ***/
  ...
  /* Constructor also connects to Gazebo's transport mechanism & creates a factory plublisher */
...
void GUIExampleSpawnWidget::OnButton()
{
  ...
  /*****************OnButton callback creates a new sphere SF string***********************/
