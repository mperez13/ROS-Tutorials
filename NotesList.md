...
|[Create SDF Model of the Velodyne Sensor](https://github.com/mperez13/ROS-Tutorials/blob/master/gazebo_notes/velodyne_gazebo.md)|Base on the Velodyne decumentation, create basic .sdf file to model the sensor|
