...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marifer/ROS-Tutorials/catkin_ws/install/${idir}'.  Ask the maintainer 'Maria Perez <mfperez13@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/marifer/ROS-Tutorials/catkin_ws/install/lib;/home/marifer/ROS-Tutorials/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
