...
GUIExampleTimeWidget::GUIExampleTimeWidget() : GUIPlugin()
{
  ...
  /******************constructor also connects to Gazebo's ~/world_stats topic******************/
...
/*when msg is received, the OnStats function is called & displayed time is updated*/
